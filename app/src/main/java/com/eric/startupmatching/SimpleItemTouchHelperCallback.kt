...
class SimpleItemTouchHelperCallback(private val mAdapter: ItemTouchHelperAdapter) :
    ...
    override fun onChildDraw(
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            val alpha: Float =
                SimpleItemTouchHelperCallback.Companion.ALPHA_FULL - Math.abs(dX) / viewHolder.itemView.width
                    .toFloat()
    ...
    override fun clearView(
        ...
        viewHolder.itemView.alpha = SimpleItemTouchHelperCallback.Companion.ALPHA_FULL
        if (viewHolder is ItemTouchHelperViewHolder) {
